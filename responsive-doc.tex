...
\noindent \DescribeKey{alphabet} String of characters which is used to calculate the average character width. By default, it includes most common lower case letters used in English texts.
...
\begin{changelog}
  ...
  \change{2026-06-29}{Changed default list of characters used in the measurement of the font size. It should correspond better to the number of characters that fit on the line, but may lead to a bigger font size.}
  \change{2026-06-29}{Added the \texttt{alphabet} option to change the list of characters used in the measurement of the font size.}
  \change{2026-05-28}{Update dimensions for lists, display math and other elements that needs to be updated according to the new font size.}
  \change{2026-05-28}{Fixed internal command names to use correct Expl 3 syntax}
